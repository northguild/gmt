...
- **~54× more CI test executions than all four competitors combined**: 1,088,040 from 36,268 tests run in all 10 timezones × 3 Node versions, vs. their combined 20,190.
- **~94× more test cases than `@internationalized/date`**: 36,268 vs. 386 — Adobe's own library, run at its own commit.
...
| ------------------------------- | -------------------------------------------------- | ------------------------------ | ------------------------------------ | ----------------------------------------- | -------------------------------- |
| Test files                      | 662                                                | 6                              | 58 / 60<br>(2 didn't run<br>locally) | 256                                       | 191<br>(52 core +<br>139 locale) |
| Individual test cases           | **36,268**                                         | 386                            | 1,222                                | 3,213                                     | 3,901                            |
| Effective CI test<br>executions | **1,088,040**<br>(36,268 × 3 Node<br>× 10 timezones) | 386<br>(×1 Node)               | 4,888<br>(1,222 × 4 Node)            | 3,213<br>(×1 Node)                        | 11,703<br>(3,901 × 3 Node)       |
...
**Result:** 36,268 tests across 662 files that exercise real behavior differences without redundant permutations. They run in CI as 1,088,040 executions — every one of them × 3 Node versions × 10 timezones.
...
| GMT's effective CI test<br>executions exceed all four<br>competitors **combined**<br>by ~54×                                                  | 1,088,040 vs. 386 + 4,888 + 3,213<br>+ 11,703 = 20,190                                                                                  |
