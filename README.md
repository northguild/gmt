...
- **~56× more CI test executions than all four competitors combined**: 1,125,000 from 37,500 tests run in all 10 timezones × 3 Node versions, vs. their combined 20,190.
- **~97× more test cases than `@internationalized/date`**: 37,500 vs. 386 — Adobe's own library, run at its own commit.
...
| Individual test cases           | **37,500**                                         | 386                            | 1,222                                | 3,213                                     | 3,901                            |
| Effective CI test<br>executions | **1,125,000**<br>(37,500 × 3 Node<br>× 10 timezones) | 386<br>(×1 Node)               | 4,888<br>(1,222 × 4 Node)            | 3,213<br>(×1 Node)                        | 11,703<br>(3,901 × 3 Node)       |
...
**Result:** 37,500 tests across 681 files that exercise real behavior differences without redundant permutations. They run in CI as 1,125,000 executions — every one of them × 3 Node versions × 10 timezones.
...
| GMT's effective CI test<br>executions exceed all four<br>competitors **combined**<br>by ~56×                                                  | 1,125,000 vs. 386 + 4,888 + 3,213<br>+ 11,703 = 20,190                                                                                  |
