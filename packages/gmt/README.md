...
- **~15× more CI test executions than all four competitors combined**: 346,760 (17,338 tests × 10 timezones × 2 Node versions) vs. their combined 20,190.
- **~40× more test cases than `@internationalized/date`**: 17,338 vs. 386 — Adobe's own library, run at its own commit.
...
**Result:** 17,338 tests across 562 files that exercise real behavior differences without redundant permutations. The suite runs in CI as 346,760 executions (17,338 × 2 Node versions × 10 timezones).
...
| ------------------------------- | -------------------------------------------------- | ------------------------------ | ------------------------------------ | ----------------------------------------- | -------------------------------- |
| Test files                      | 562                                                | 6                              | 58 / 60<br>(2 didn't run<br>locally) | 256                                       | 191<br>(52 core +<br>139 locale) |
| Individual test cases           | **17,338**                                         | 386                            | 1,222                                | 3,213                                     | 3,901                            |
| Effective CI test<br>executions | **346,760**<br>(17,338 × 2 Node<br>× 10 timezones) | 386<br>(×1 Node)               | 4,888<br>(1,222 × 4 Node)            | 3,213<br>(×1 Node)                        | 11,703<br>(3,901 × 3 Node)       |
...
| GMT's effective CI test<br>executions exceed all four<br>competitors **combined**<br>by ~15×                                                  | 346,760 vs. 386 + 4,888 + 3,213<br>+ 11,703 = 20,190                                                                                  |
