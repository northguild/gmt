...
describe("zonedUnitStart and nextZonedBucketStart for every DateTimeUnit", () => {
  it.each`
    ...
    ${"2010-09-30T21:30:00Z"}           | ${"quarter"}     | ${undefined} | ${"Africa/Cairo"}      | ${"2010-06-30T21:00:00Z"}           | ${"2010-09-30T22:00:00Z"}
    ${"1978-09-30T23:30:00Z"}           | ${"quarter"}     | ${undefined} | ${"Africa/Tunis"}      | ${"1978-09-30T22:00:00Z"}           | ${"1978-12-31T23:00:00Z"}
