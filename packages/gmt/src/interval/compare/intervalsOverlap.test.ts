...
describe("intervalsOverlap", () => {
  ...
  it.each`
    ...
    ${"2024-01-01T09:00:00Z[u-ca=iso8601]"}          | ${"2024-01-01T17:00:00Z"}                     | ${"2024-01-01T12:00:00Z[!u-ca=hebrew]"} | ${"2024-01-01T18:00:00Z[foo=bar]"}         | ${true}  | ${"partial, annotations ignored by Instant.from"}
    ${"2024-01-01T09:00:00Z"}                        | ${"2024-01-01T17:00:00Z[u-ca=iso8601]"}       | ${"2024-01-01T17:00:00Z[foo=bar]"}      | ${"2024-01-01T18:00:00Z"}                  | ${false} | ${"touching, annotations ignored"}
  `(
