...
describe("intersectIntervals", () => {
  ...
  it("intersects annotated endpoints by instant and keeps each winner's annotated text", () => {
    expect(
      intersectIntervals(
        {
        ...
        {
          start: "2024-01-01T12:00:00Z[foo=bar]",
          end: "2024-01-01T18:00:00Z[!u-ca=hebrew]",
        },
      ),
    ).toEqual({
      start: "2024-01-01T12:00:00Z[foo=bar]",
