...
describe("parseWeekFromDateTime", () => {
  ...
  it.each`
    ...
    ${"2023-12-31T12:00:00"} | ${1}     | ${"Sunday of the week holding 1 January 2024 (a Monday)"}
    ${"2024-01-01T12:00:00"} | ${1}     | ${"Monday; week 1 of 2024 is Sun 2023-12-31 to Sat 2024-01-06"}
    ${"2024-03-17T12:00:00"} | ${12}    | ${"Sunday; its Saturday 2024-03-23 is day 83 = 6 + 7 x 11"}
    ${"2024-12-28T12:00:00"} | ${52}    | ${"Saturday, day 363 = 6 + 7 x 51"}
    ${"2024-12-29T12:00:00"} | ${1}     | ${"Sunday of the week holding 1 January 2025 (a Wednesday)"}
    ${"2024-12-31T12:00:00"} | ${1}     | ${"Tuesday in the week holding 1 January 2025"}
    ${"2000-01-01T12:00:00"} | ${1}     | ${"Saturday 1 January: a one-day-in-year week 1"}
    ${"2000-01-02T12:00:00"} | ${2}     | ${"Sunday after that one-day week 1"}
    ${"2000-12-30T12:00:00"} | ${53}    | ${"Saturday, day 365 = 1 + 7 x 52"}
    ${"2000-12-31T12:00:00"} | ${1}     | ${"Sunday of the week holding 1 January 2001 (a Monday)"}
    ${"2016-12-31T12:00:00"} | ${53}    | ${"Saturday, day 366 = 2 + 7 x 52 (1 January 2016 was a Friday)"}
    ${"2017-01-01T12:00:00"} | ${1}     | ${"Sunday 1 January starts week 1"}
  `(
    "returns $expected for $value with weekStartsOn sunday ($reason)",
    ({ value, expected }) => {
      expect(parseWeekFromDateTime(value, { weekStartsOn: "sunday" })).toBe(
        expected,
      );
    },
  );
  ...
  it.each`
    ...
    ${true}
  `(
    "returns null for 2024-03-15T12:00:00 with invalid weekStartsOn $weekStartsOn",
    ({ weekStartsOn }) => {
      expect(
        parseWeekFromDateTime("2024-03-15T12:00:00", { weekStartsOn }),
      ).toBeNull();
    },
  );
});
