...
describe("intervalUnionDateTime", () => {
  ...
  it.each`
    ...
    ${"2024-01-01T09:00:00"} | ${"2024-01-01T09:00:00"} | ${"2024-01-01T12:00:00"}           | ${"2024-01-01T17:00:00"} | ${{ start: "2024-01-01T12:00:00", end: "2024-01-01T17:00:00" }}
    ${"2024-01-01T09:00:00"} | ${"2024-01-01T12:00:00"} | ${"2024-01-01T12:00:00.000000001"} | ${"2024-01-01T17:00:00"} | ${null}
  `(
