 ...
 *
 * - Converts to PlainDate in `timeZone`: omitted is UTC, `"local"` is the system zone, and an
 ...
 * @example convertUnixToPlainDate(1709164800000) // "2024-02-29" (UTC by default)
