...
describe("transitTime", () => {
  ...
  `("returns the sentinel for $duration ($reason)", ({ duration }) => {
    expect(
  ...
  it.each`
    ...
    ${"2024-06-15T10:00:00+05:30:00,5"}  | ${"PT1H"}    | ${"2024-06-15T11:00:00+05:30:00,5"}  | ${"comma decimal sign (ISO 8601, Temporal TemporalDecimalSeparator) kept as written"}
    ${"2024-06-15T10:00:00+05:30:15,25"} | ${"PT1H"}    | ${"2024-06-15T11:00:00+05:30:15,25"} | ${"comma fraction: 04:29:44.75Z + 1h read at +05:30:15.25"}
